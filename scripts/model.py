...
for target in targets:
    ...
    plt.ylabel('Real')
    plt.savefig(f'images/confusion_matrix {target.lower().replace("_", " ")}.png')
    plt.show()
    ...
    plt.savefig(f'images/feature_importance {target.lower().replace("_", " ")}.png', bbox_inches='tight')
    plt.show()
...
feature_importance_df.to_csv('data/feature_importance.csv', index=False, encoding='utf-8')

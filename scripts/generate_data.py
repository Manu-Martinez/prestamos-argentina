...
df.to_csv('../data/clientes_ficticios_abril2025.csv', index=False, encoding='utf-8')
...
df.to_csv('../data/clientes_ficticios_abril2025_tableau.csv', index=False, encoding='utf-8')
...
df = pd.read_csv('data/clientes_ficticios_abril2025.csv', encoding='utf-8')
print(df.describe())
...
plt.savefig('images/income_distribution_feb_apr2025.png')
plt.show()
...
plt.savefig('images/loan_eligibility_small_by_employment_april2025.png')
plt.show()
...
plt.ylabel('Cantidad de Clientes')
plt.legend(title='Elegibilidad')
plt.savefig('images/loan_eligibility_medium_by_employment_april2025.png')
plt.show()
...
plt.ylabel('Cantidad de Clientes')
plt.legend(title='Elegibilidad')
plt.savefig('images/loan_eligibility_large_by_employment_april2025.png')
plt.show()
...
plt.tight_layout()
plt.savefig('images/correlation_matrix_feb_apr2025.png', bbox_inches='tight')
plt.show()

# Exportar la matriz de correlación a CSV
correlation_matrix.to_csv('data/correlation_matrix.csv', encoding='utf-8-sig', index=True)